...
import { MessageSquarePlus, CheckCircle2, Clock, MapPin, X, Send, Sparkles, AlertCircle } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        {/* Live List of Recent Community Care Reports */}
      ...
      {/* Friendly Modal: Lapor Lingkungan */}
      {isOpenModal && (
        <div
