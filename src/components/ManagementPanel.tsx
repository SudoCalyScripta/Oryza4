...
import { Shield, Sparkles, X, Bell, ArrowUpRight, CheckCircle2 } from 'lucide-react';
        ...
        >
            ...
            >
                        ...
                        <div className="flex items-center p-1 rounded-full bg-white/10 border border-white/15 text-xs">
                            {(['PIC', 'Wakil PIC', 'Bendahara'] as UserRole[]).map((r) => (
                                <button
                                    ...
                                    className={`px-3 py-1 rounded-full transition-all text-[11px] ${currentRole === r
                        ...
                        <div className="frost-glass-dark rounded-2xl p-5 border border-[#D8C28F]/20 flex flex-col justify-between">
                            ...
                            <div className="mt-4 pt-3 border-t border-white/10 flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className={`text-xs px-3 py-1 rounded-full transition-all ${verifiedItems['iuran-pending']
                        ...
                        <div className="frost-glass-dark rounded-2xl p-5 border border-[#D8C28F]/20 flex flex-col justify-between">
                            ...
                            <div className="mt-4 pt-3 border-t border-white/10 flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className={`text-xs px-3 py-1 rounded-full transition-all ${verifiedItems['rep-12']
                                            ? 'bg-[#657A52]/80 text-[#D8C28F]'
                ...
                <div className="p-4 sm:p-6 bg-[#1D2B1E]/80 border-t border-white/10 flex items-center justify-between text-xs text-[#F7F3E8]/60">
                    <span>Sistem Pengelolaan Internal Oryza 4 • 25 Rumah</span>
                    <button
                        onClick={onClose}
