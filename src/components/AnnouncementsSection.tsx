...
export const AnnouncementsSection: React.FC = () => {
    ...
    return (
        ...
        >
            {/* Background Architectural Texture with gentle parallax effect */}
            <div
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
                    <div>
                        ...
                        <p className="mt-2 text-sm sm:text-base text-[#F7F3E8]/75 font-light max-w-lg">
                            Kabar penting, agenda gotong royong, dan pembaruan fasilitas langsung dari jajaran pengurus Paguyuban Oryza 4.
                        </p>
                    </div>

                    <div className="flex items-center gap-2">
                        <span className="text-xs text-[#F7F3E8]/60">Diperbarui berkala untuk 26 rumah</span>
                    </div>
                </div>

                {/* Featured Editorial Announcement Card + Secondary List */}
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
                    {/* Main Featured Announcement Card (7 Cols) */}
                    ...
                    {/* Secondary Announcements Tab / List (5 Cols) */}
