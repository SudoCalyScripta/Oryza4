...
import { Camera, Eye, X, Sparkles, Calendar, User, Heart, Upload } from 'lucide-react';
                ...
                <div className="flex items-center gap-2 overflow-x-auto pb-4 mb-8">
                    {[
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-full text-xs font-medium tracking-wide whitespace-nowrap transition-all duration-300 ${selectedFilter === tab.id
                                ...
                                <div className="p-4 bg-[#252821]/85 border-t border-white/10 flex items-center justify-between text-xs text-white/70">
                                    ...
                                    <div className="flex items-center gap-3 shrink-0">
                                        <button
                                            ...
                                            className={`flex items-center gap-1.5 transition-colors ${isLiked ? 'text-rose-400 font-semibold' : 'hover:text-rose-300'
                                                }`}
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                ...
                                <div className="flex items-center gap-3">
                                    <button
                                        ...
                                        className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-semibold border transition-all ${likedMap[activeItem.id]
