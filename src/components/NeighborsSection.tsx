                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 p-3 rounded-2xl bg-white/70 backdrop-blur-md border border-[#354936]/15 shadow-xs">
                    ...
                    <div className="flex flex-wrap items-center gap-1.5 text-xs overflow-x-auto pb-1 md:pb-0">
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-xl font-medium transition-all text-[11px] ${filterType === 'all'
                        ...
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-xl font-medium transition-all text-[11px] ${filterType === 'sampah-lunas'
                                    ? 'bg-[#354936] text-[#F7F3E8] shadow-xs'
                                    : 'text-[#756653] hover:text-[#354936] hover:bg-[#D8C28F]/25'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-xl font-medium transition-all text-[11px] ${filterType === 'sampah-belum'
                        ...
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-xl font-medium transition-all text-[11px] ${filterType === 'stiker-lunas'
                                    ? 'bg-[#354936] text-[#F7F3E8] shadow-xs'
                                    : 'text-[#756653] hover:text-[#354936] hover:bg-[#D8C28F]/25'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-xl font-medium transition-all text-[11px] ${filterType === 'stiker-belum'
